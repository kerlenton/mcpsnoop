...
// decodeHeaderValue is the Mcp-Name reading of a routing header. The sentinel
// itself is defined by the transport, so the one implementation lives in the
// proxy and both the shim's redaction and the checks here share it. A value
